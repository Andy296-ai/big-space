...
<template>
    ...
    >
        <div
            class="animate-in fade-in zoom-in-95 w-full max-w-sm space-y-4 rounded-3xl border border-slate-700/80 bg-slate-900 p-6 text-slate-100 shadow-2xl duration-200"
        >
